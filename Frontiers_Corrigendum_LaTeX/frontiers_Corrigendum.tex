...
% Affiliations of all authors must be the same as they appear in the published original version of the article.
...
\title[Corrigendum]{Corrigendum: [TITLE OF ORIGINAL ARTICLE AS PUBLISHED]} % this must be the full title of the origninal article
...
%Insert new Author Contributions Statement
